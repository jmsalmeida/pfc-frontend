...
import { Layout, TopNavigation, Input, Icon, Button } from '@ui-kitten/components';
import { LogoutAction } from '../../Components/Logout/logout-action.component';
import { PartyPlaceCard } from './party-place-card.component';
...
export const SearchPartyScreen = () => {
  ...
  const getPartyPlaces = async (partyPlaceName = null) => {
    ...
    const api = 'http://localhost:3000/party-places';
